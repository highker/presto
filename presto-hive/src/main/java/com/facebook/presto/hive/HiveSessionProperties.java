...
public final class HiveSessionProperties
{
    ...
    public static final String PARTITION_STATS_BASED_OPTIMIZATION_ENABLED = "partition_stats_based_optimization_enabled";
    ...
    public HiveSessionProperties(HiveClientConfig hiveClientConfig, OrcFileWriterConfig orcFileWriterConfig, ParquetFileWriterConfig parquetFileWriterConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                booleanProperty(
                        ...
                        false),
                booleanProperty(
                        PARTITION_STATS_BASED_OPTIMIZATION_ENABLED,
                        "Enables partition stats based optimization, including partition pruning and predicate stripping",
                        hiveClientConfig.isPartitionStatsBasedOptimizationEnabled(),
                        false),
                booleanProperty(
    ...
    public static boolean isPartitionStatsBasedOptimizationEnabled(ConnectorSession session)
    {
        return session.getProperty(PARTITION_STATS_BASED_OPTIMIZATION_ENABLED, Boolean.class);
    }
