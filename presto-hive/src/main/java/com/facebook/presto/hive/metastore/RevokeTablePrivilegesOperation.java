...
@Immutable
public class RevokeTablePrivilegesOperation
         implements ExclusiveOperation
{
    ...
    @JsonCreator
    public RevokeTablePrivilegesOperation(
    ...
    public boolean equals(Object other)
    {
        ...
        RevokeTablePrivilegesOperation otherOperation = (RevokeTablePrivilegesOperation) other;
