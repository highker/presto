         ...
         implements ExclusiveOperation
{
    ...
    public RenameTableOperation(
            ...
            @JsonProperty("newDatabaseName") String newDatabaseName,
            @JsonProperty("newTableName") String newTableName)
    {
    ...
    public boolean equals(Object other)
    {
        ...
        RenameTableOperation otherOperation = (RenameTableOperation) other;
        return Objects.equals(databaseName, otherOperation.databaseName) &&
                Objects.equals(tableName, otherOperation.tableName) &&
                Objects.equals(newDatabaseName, otherOperation.newDatabaseName) &&
                Objects.equals(newTableName, otherOperation.newTableName);
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(databaseName, tableName, newDatabaseName, newTableName);
    }
}
