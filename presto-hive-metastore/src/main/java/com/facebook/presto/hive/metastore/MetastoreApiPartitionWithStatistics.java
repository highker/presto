...
public class MetastoreApiPartitionWithStatistics
{
    private final org.apache.hadoop.hive.metastore.api.Partition partition;
    private final String partitionName;
    private final PartitionStatistics statistics;

    public MetastoreApiPartitionWithStatistics(org.apache.hadoop.hive.metastore.api.Partition partition, String partitionName, PartitionStatistics statistics)
    {
