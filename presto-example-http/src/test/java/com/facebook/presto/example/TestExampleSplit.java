...
public class TestExampleSplit
{
    ...
    public void testAddresses()
    {
        ...
        assertEquals(httpSplit.getNodeSelectionStrategy(), NodeSelectionStrategy.NO_PREFERENCE);
        ...
        assertEquals(httpsSplit.getNodeSelectionStrategy(), NodeSelectionStrategy.NO_PREFERENCE);
