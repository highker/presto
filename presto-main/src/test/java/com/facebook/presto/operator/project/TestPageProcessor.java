...
public class TestPageProcessor
{
            ...
            throws Exception
    {
        ...
        // The purpose of this test is NOT to test the yield signal in page projection; we have other test to cover that
        // In page processor, we check yield signal after a column has been completed processed
        // So we want to set yield signal when the column has just finished processing in order to let page processor capture the yield signal when the block is returned
