...
public class TestEffectivePredicateExtractor
{
    ...
    private static final Expression AE = new SymbolReference(A.getName());
    private static final Expression BE = new SymbolReference(B.getName());
    private static final Expression CE = new SymbolReference(C.getName());
    private static final Expression DE = new SymbolReference(D.getName());
    private static final Expression EE = new SymbolReference(E.getName());
    private static final Expression FE = new SymbolReference(F.getName());
    private static final Expression GE = new SymbolReference(G.getName());
