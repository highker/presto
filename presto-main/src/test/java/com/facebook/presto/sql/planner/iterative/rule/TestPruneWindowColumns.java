        ...
        extends BaseRuleTest
{
    ...
    private static final FunctionHandle FUNCTION_HANDLE = createTestMetadataManager().getFunctionManager().resolveFunction(TEST_SESSION, QualifiedName.of(FUNCTION_NAME), fromTypes(BIGINT));
