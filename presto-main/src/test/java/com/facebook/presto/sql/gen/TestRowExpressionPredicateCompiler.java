...
public class TestRowExpressionPredicateCompiler
{
    ...
    public void test()
    {
        ...
        assertFalse(compiledSum.evaluate(page, 0));
        assertFalse(compiledSum.evaluate(page, 1));
        assertTrue(compiledSum.evaluate(page, 2));
        assertTrue(compiledSum.evaluate(page, 3));
        assertFalse(compiledSum.evaluate(page, 4));
        ...
        assertTrue(compiledTimesTwo.evaluate(page, 0));
        assertTrue(compiledTimesTwo.evaluate(page, 1));
        assertFalse(compiledTimesTwo.evaluate(page, 2));
        assertFalse(compiledTimesTwo.evaluate(page, 3));
        assertTrue(compiledTimesTwo.evaluate(page, 4));
    }
