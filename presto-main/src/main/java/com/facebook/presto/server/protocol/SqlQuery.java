        ...
        extends AbstractQuery
{
    ...
    {
        SqlQuery result = new SqlQuery(queryId, session, queryManager, exchangeClient, dataProcessorExecutor, timeoutExecutor, blockEncodingSerde);
            ...
            implements QueryFactory<SqlQuery>
    {
        ...
        @Override
        public SqlQuery create(QueryId queryId, Session session, QueryManager queryManager)
        {
