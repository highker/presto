        ...
        implements Closeable
{
    ...
    public synchronized ExchangeClientStatus getStatus()
    {
        ...
        return new ExchangeClientStatus(bufferBytes, maxBufferBytes, reservedBytes.get(), successfulRequests, bufferedPages, noMoreLocations, exchangeStatus.build());
    }
            ...
            implements ClientCallback
    {
        ...
        {
            ExchangeClient.this.releaseQuota(quotaInBytes);
        }
    }
