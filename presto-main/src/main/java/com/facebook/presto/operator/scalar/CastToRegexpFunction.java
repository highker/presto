        ...
        extends SqlOperator
{
        ...
        switch (library) {
            case JONI:
                return new ScalarFunctionImplementation(
                        ...
                        insertArguments(JONI_METHOD_HANDLE, 0, padSpaces, boundVariables.getLongVariable("x")), true);
            case RE2J:
                return new ScalarFunctionImplementation(
                        false, ImmutableList.of(false),
    ...
    public static AbstractRegexp castToJoniRegexp(boolean padSpaces, long typeLength, Slice pattern)
    {
        if (padSpaces) {
    ...
    public static AbstractRegexp castToRe2JRegexp(int dfaStatesLimit, int dfaRetries, boolean padSpaces, long typeLength, Slice pattern)
    {
        if (padSpaces) {
            pattern = padSpaces(pattern, (int) typeLength);
        }
