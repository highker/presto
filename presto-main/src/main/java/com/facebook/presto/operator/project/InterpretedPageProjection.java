        ...
        public Optional<Block> compute()
        {
            ...
            if (selectedPositions.isList()) {
                for (int index = nextIndexOrPosition; index < length; index++) {
                    writeNativeValue(evaluator.getType(), blockBuilder, evaluator.evaluate(selectedPositions.getPositions()[index], blocks));
                ...
                for (int position = nextIndexOrPosition; position < length; position++) {
                    writeNativeValue(evaluator.getType(), blockBuilder, evaluator.evaluate(position, blocks));
                    if (yieldSignal.isSet()) {
