...
public final class RegexpFunctions
{
    ...
    public static boolean regexpLike(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpReplace(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern)
    {
    ...
    @SqlType("varchar(z)")
    public static Slice regexpReplace(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern, @SqlType("varchar(y)") Slice replacement)
    {
    ...
    public static Block regexpExtractAll(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("array(varchar(x))")
    public static Block regexpExtractAll(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern, @SqlType(StandardTypes.BIGINT) long groupIndex)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpExtract(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern)
    {
    ...
    @LiteralParameters("x")
    @SqlType("varchar(x)")
    public static Slice regexpExtract(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern, @SqlType(StandardTypes.BIGINT) long groupIndex)
    {
    ...
    @SqlType("array(varchar(x))")
    public static Block regexpSplit(@SqlType("varchar(x)") Slice source, @SqlType(RegexpType.NAME) AbstractRegexp pattern)
    {
