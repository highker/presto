...
@ThreadSafe
public final class RunningSqlQueryExecution
        extends SqlQueryExecution
{
    private static final Logger log = Logger.get(RunningSqlQueryExecution.class);
    ...
    private RunningSqlQueryExecution(QueryId queryId,
            String query,
            Session session,
            URI self,
            Statement statement,
    ...
    public static class RunningSqlQueryExecutionFactory
            implements QueryExecutionFactory<RunningSqlQueryExecution>
    {
        private final SplitSchedulerStats schedulerStats;
        private final int scheduleSplitBatchSize;
        private final Metadata metadata;
        ...
        @Inject
        RunningSqlQueryExecutionFactory(QueryManagerConfig config,
        ...
        public RunningSqlQueryExecution createQueryExecution(QueryId queryId, String query, Session session, Statement statement, List<Expression> parameters)
        {
            ...
            return new RunningSqlQueryExecution(
                    queryId,
                    query,
                    session,
