        ...
        extends AbstractQueryExecution
{
    ...
    private final DispatchTransactionManager dispatchTransactionManager;
    ...
    DispatchQueryExecution(
            ...
            DispatchTransactionManager dispatchTransactionManager,
            ...
            List<Expression> parameters)
    {
        ...
        try (SetThreadName ignored = new SetThreadName("Query-%s", queryId)) {
            ...
            addStateChangeListener(newState -> {
                ...
                if ((newState == SUBMITTING || newState.isDone()) && isTransactionActive.compareAndSet(true, false)) {
            ...
            if (session.getTransactionId().isPresent()) {
                ...
                if (transactionCoordinator == null) {
                    throw new PrestoException(UNKNOWN_TRANSACTION, format("found unknown transaction ID: %s", session.getTransactionId().get()));
                }
    ...
    public QueryInfo getQueryInfo()
    {
        ...
        return new QueryInfo(
                ...
                hasInfo ? queryInfo.getMemoryPool() : EMPTY_MEMORY_POOL_ID,
    ...
    private void finish()
    {
        ...
        if (queryInfo.isClearTransactionId()) {
            ...
            checkState(dispatchTransactionManager.getCoordinator(queryInfo.getStartedTransactionId().get()) == null);
            dispatchTransactionManager.addTransaction(queryInfo.getStartedTransactionId().get(), coordinatorUri.get());
        }
