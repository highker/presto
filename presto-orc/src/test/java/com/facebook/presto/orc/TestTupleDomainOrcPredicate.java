...
public class TestTupleDomainOrcPredicate
{
    ...
    private static ColumnStatistics stringColumnStats(Long numberOfValues, String minimum, String maximum)
    {
        ...
        return new ColumnStatistics(numberOfValues, 10L, null, null, null, new StringStatistics(getMinSlice(minimum), getMaxSlice(maximum), 100L), null, null, null, null);
    }
    ...
    {
        return new ColumnStatistics(numberOfValues, Integer.BYTES, null, null, null, null, new DateStatistics(minimum, maximum), null, null, null);
    }
    ...
    private static ColumnStatistics decimalColumnStats(Long numberOfValues, String minimum, String maximum)
    {
        ...
        return new ColumnStatistics(numberOfValues, 8L, null, null, null, null, null, new DecimalStatistics(minimumDecimal, maximumDecimal), null, null);
    }
