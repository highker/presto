...
public class TestTupleDomainOrcPredicate
{
            ...
            throws Exception
    {
        ...
        assertEquals(getDomain(VARBINARY, 0, binaryColumnStats(null, 0L)), none(VARBINARY));
        assertEquals(getDomain(VARBINARY, 0, binaryColumnStats(0L, 0L)), none(VARBINARY));
        assertEquals(getDomain(VARBINARY, 0, binaryColumnStats(0L, 0L)), none(VARBINARY));

        assertEquals(getDomain(VARBINARY, 10, binaryColumnStats(0L, 0L)), onlyNull(VARBINARY));
        assertEquals(getDomain(VARBINARY, 10, binaryColumnStats(10L, 100L)), notNull(VARBINARY));

        assertEquals(getDomain(VARBINARY, 20, binaryColumnStats(10L, 100L)), all(VARBINARY));
    }

    private static ColumnStatistics binaryColumnStats(Long numberOfValues, long sum)
    {
        return new ColumnStatistics(numberOfValues, null, null, null, null, null, null, new BinaryStatistics(sum), null);
    }
